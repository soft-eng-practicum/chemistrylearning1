...
level5.prototype = {  
    ...
    //Main Phaser Create Function
  	create: function(){ 
        ...
        //Countdown Label
        countDownLabel = this.game.add.text(this.game.world.centerX-45, 10, "", {font: "120px Courier", fill: "#ffffff"});
    ...
    moveSprite: function(pointer) {
        ...
        guyTween.onComplete.add(this.moveComplete, this);
    ...
    //Guy and flask Collision Function
