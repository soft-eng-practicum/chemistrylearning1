...
signUpState.prototype = {
    ...
    create: function () {
        ...
        userCreated = this.game.add.text(this.game.world.centerX-200, 550, "User Successfully Created", {font: "30px Courier", fill: "#ffffff", align: "center"});
        userCreated.visible = false;
        
        //Displays a message if the user is created unsuccessfully.
        userNotcreated = this.game.add.text(this.game.world.centerX-250, 550, "GGC Email Address Required", {font: "30px Courier", fill: "#ffffff", align: "center"});
        ...
        submitButton = this.game.add.button(300, 698, "submitButton", this.createPlayer, this);
    ...
    createPlayer: function () {
        ...
        //If the email 
//        if(newEmail > 0 && newEmail.includes("@ggc.edu"))
//            {        
            $.ajax({
